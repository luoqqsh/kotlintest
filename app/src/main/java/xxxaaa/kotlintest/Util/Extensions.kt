package xxxaaa.kotlintest.Util
import android.content.Context
import android.support.v4.app.Fragment
import android.view.View
import android.widget.Toast
import xxxaaa.kotlintest.Application.YLApplication
...
fun Context.showToast(content: String): Toast {
    val toast = Toast.makeText(YLApplication.context, content, Toast.LENGTH_SHORT)
    toast.show()
    return toast
}
